...
async function showCheckoutModal(orderData) {
    ...
    try {
        ...
        // Update the checkout modal header with the correct amount
        ...
        // Remove any existing amount display box to avoid redundancy
        const existingAmountDisplay = checkoutModal.querySelector('.amount-display');
        if (existingAmountDisplay) {
            existingAmountDisplay.remove();
        }
